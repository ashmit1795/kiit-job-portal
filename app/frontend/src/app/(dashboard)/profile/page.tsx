...
import { User, GraduationCap, Link as LinkIcon, FileText, Bell } from "lucide-react";
...
import { NotificationsPrefs } from "@/components/features/profile/notifications-prefs";
    ...
    <div className="w-full max-w-5xl mx-auto space-y-8 pb-10">
      ...
      <Tabs defaultValue="overview" className="w-full">
        <TabsList className="bg-muted/30 border border-border/50 mb-6 flex w-full overflow-x-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] gap-2 h-auto p-1 justify-start">
          ...
          {user.role !== "admin" && (
            <TabsTrigger value="notifications" className="gap-2 data-[state=active]:bg-emerald-600/15 data-[state=active]:text-emerald-400">
